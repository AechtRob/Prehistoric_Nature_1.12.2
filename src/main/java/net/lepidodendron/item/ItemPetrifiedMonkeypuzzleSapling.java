...
public class ItemPetrifiedMonkeypuzzleSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:petrified_monkeypuzzle_sapling")
	public static final Item block = null;
	public ItemPetrifiedMonkeypuzzleSapling(ElementsLepidodendronMod instance) {
	...
	public static class ItemCustom extends ItemPetrified {
		public ItemCustom() {
			super(BlockMonkeypuzzleSapling.block);
