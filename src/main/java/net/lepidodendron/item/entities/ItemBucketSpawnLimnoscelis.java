...
public class ItemBucketSpawnLimnoscelis extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/limnoscelis_spawn_bucket", "inventory"));
	}
				...
				else
				{
					...
					else
					{
						...
						if (!(worldIn.isRemote) && (worldIn.getBlockState(posIn.up()).getMaterial() == Material.WATER)
							...
							worldIn.setBlockState(posIn, BlockAmphibianSpawnLimnoscelisPlaceable.block.getDefaultState());
						}
					}
