			...
			if (!worldIn.isRemote) {
				...
				if (raytraceresult == null) {
					...
					if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK) {
						...
						Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getKey(EntityPrehistoricFloraScorpion_Gigantoscorpio.class), blockpos.getX() + 0.5, blockpos.getY() + 0.5, blockpos.getZ() + 0.5);
						if (entity != null) {
