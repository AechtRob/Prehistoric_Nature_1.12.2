...
public class ItemBucketSpawnAmphibamus extends ElementsLepidodendronMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("lepidodendron:entities/amphibamus_spawn_bucket", "inventory"));
	}
				...
				else
				{
					...
					else
					{
						...
						if (!(worldIn.isRemote) && (worldIn.getBlockState(posIn.up()).getMaterial() == Material.WATER)
							...
							worldIn.setBlockState(posIn, BlockAmphibianSpawnAmphibamusPlaceable.block.getDefaultState());
						}
					}
