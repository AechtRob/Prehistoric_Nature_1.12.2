...
public class ItemMonkeyPuzzleNuts extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:monkey_puzzle_nuts")
	public static final Item block = null;
	public ItemMonkeyPuzzleNuts(ElementsLepidodendronMod instance) {
	...
	public static class ItemFoodCustom extends ItemPrehistoricPlantable {
		public ItemFoodCustom() {
			super(BlockMonkeypuzzleSapling.block,1);
