...
public class EntityPrehistoricFloraArchoblattina extends EntityPrehistoricInsectFlyingWalkingBase {
	...
	public EntityPrehistoricFloraArchoblattina(World world) {
		super(world);
