	...
	public void onEntityUpdate()
	{
		...
		if (this.getAgeScale() >= 0.99)
		{
			if (!(world.isRemote)) {
				...
				entity = ItemMonsterPlacer.spawnCreature(this.getEntityWorld(), EntityList.getKey(EntityPrehistoricFloraArchoblattina.class), (double) pos.getX() + 0.5D, (double) pos.getY() + 0.5D, (double) pos.getZ() + 0.5D);
				if (entity != null) {
					this.setDead();
