...
public class ModelHibbertopterus extends AdvancedModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        if (!e.isInWater()) {
            ...
            this.swing(l3R_r1, 0.12F, -0.12F, false, 2, -0.1F, f2, 1F);
            this.swing(l4L, 0.12F, 0.2F, false, 0, -0.1F, f2, 1F);
            this.swing(l5L, 0.12F, 0.2F, false, 2, -0.1F, f2, 1F);
            this.swing(l4R, 0.12F, -0.2F, false, 0, -0.1F, f2, 1F);
            this.swing(l5R, 0.12F, -0.2F, false, 2, -0.1F, f2, 1F);
        } else {
            this.swing(l3L_r1, 0.2F, -0.12F, false, 0, -0.1F, f2, 1F);
            this.swing(l3R_r1, 0.2F, -0.12F, false, 2, -0.1F, f2, 1F);
            this.swing(l4L, 0.2F, 0.2F, false, 0, -0.1F, f2, 1F);
            this.swing(l5L, 0.2F, 0.2F, false, 2, -0.1F, f2, 1F);
            this.swing(l4R, 0.2F, -0.2F, false, 0, -0.1F, f2, 1F);
            this.swing(l5R, 0.2F, -0.2F, false, 2, -0.1F, f2, 1F);
        }
