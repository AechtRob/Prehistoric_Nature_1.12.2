...
public class ModelSchinderhannes extends AdvancedModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        if (e instanceof EntityLiving && !((EntityLiving) e).isAIDisabled()) {
            ...
            this.flap(finupperL, 0.5F, -0.6F, false, 0, -0.5F, f2, 0.7F);
            this.flap(finupperR, 0.5F, 0.6F, false, 0, 0.5F, f2, 0.7F);
            this.flap(finupperL2, 0.5F, -0.6F, false, 0.5F, -0.5F, f2, 0.7F);
            this.flap(finupperR2, 0.5F, 0.6F, false, 0.5F, 0.5F, f2, 0.7F);
            this.flap(finupperL3, 0.5F, -0.6F, false, 1.0F, -0.5F, f2, 0.7F);
            this.flap(finupperR3, 0.5F, 0.6F, false, 1.0F, 0.5F, f2, 0.7F);
            this.flap(finupperL4, 0.5F, -0.6F, false, 1.5F, -0.5F, f2, 0.7F);
            this.flap(finupperR4, 0.5F, 0.6F, false, 1.5F, 0.5F, f2, 0.7F);
            this.flap(finupperL5, 0.5F, -0.6F, false, 2.0F, -0.5F, f2, 0.7F);
            this.flap(finupperR5, 0.5F, 0.6F, false, 2.0F, 0.5F, f2, 0.7F);
            this.flap(finupperL6, 0.5F, -0.6F, false, 2.5F, -0.5F, f2, 0.7F);
            this.flap(finupperR6, 0.5F, 0.6F, false, 2.5F, 0.5F, f2, 0.7F);
            this.flap(finupperL7, 0.5F, -0.6F, false, 3.0F, -0.5F, f2, 0.7F);
            this.flap(finupperR7, 0.5F, 0.6F, false, 3.0F, 0.5F, f2, 0.7F);
            this.flap(finupperL8, 0.5F, -0.6F, false, 3.5F, -0.5F, f2, 0.7F);
            this.flap(finupperR8, 0.5F, 0.6F, false, 3.5F, 0.5F, f2, 0.7F);

            this.flap(finlowerL, 0.5F, -0.5F, false, 0, -0.5F, f2, 0.3F);
            this.flap(finlowerR, 0.5F, 0.5F, false, 0, 0.5F, f2, 0.3F);
            this.flap(finlowerL2, 0.5F, -0.5F, false, 1.0F, -0.5F, f2, 0.3F);
            this.flap(finlowerR2, 0.5F, 0.5F, false, 1.0F, 0.5F, f2, 0.3F);
            this.flap(finlowerL3, 0.5F, -0.5F, false, 2.0F, -0.5F, f2, 0.3F);
            this.flap(finlowerR3, 0.5F, 0.5F, false, 2.0F, 0.5F, f2, 0.3F);
            this.flap(finlowerL4, 0.5F, -0.5F, false, 3.0F, -0.5F, f2, 0.3F);
            this.flap(finlowerR4, 0.5F, 0.5F, false, 3.0F, 0.5F, f2, 0.3F);
            this.flap(finlowerL5, 0.5F, -0.5F, false, 4.0F, -0.5F, f2, 0.3F);
            this.flap(finlowerR5, 0.5F, 0.5F, false, 4.0F, 0.5F, f2, 0.3F);
            this.flap(finlowerL6, 0.5F, -0.5F, false, 5.0F, -0.5F, f2, 0.3F);
            this.flap(finlowerR6, 0.5F, 0.5F, false, 5.0F, 0.5F, f2, 0.3F);
