...
public class ModelKalbarria extends AdvancedModelBase {
    ...
    public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
        ...
        if (isAtBottom || !e.isInWater()) {
            ...
            this.flap(legL, 0.5F, -0.4F, false, 0, -0.4F, f2, 0.25F);
            this.flap(legR, 0.5F, 0.4F, false, 0, 0.4F, f2, 0.25F);
            this.flap(legL2, 0.5F, -0.4F, false, 1.0F, -0.4F, f2, 0.25F);
            this.flap(legR2, 0.5F, 0.4F, false, 1.0F, 0.4F, f2, 0.25F);
            this.flap(legL3, 0.5F, -0.4F, false, 2.0F, -0.4F, f2, 0.25F);
            this.flap(legR3, 0.5F, 0.4F, false, 2.0F, 0.4F, f2, 0.25F);
            this.flap(legL4, 0.5F, -0.35F, false, 3.0F, -0.35F, f2, 0.25F);
            this.flap(legR4, 0.5F, 0.35F, false, 3.0F, 0.35F, f2, 0.25F);
            this.flap(legL5, 0.5F, -0.3F, false, 2.0F, -0.3F, f2, 0.25F);
            this.flap(legR5, 0.5F, 0.3F, false, 2.0F, 0.3F, f2, 0.25F);
            this.flap(legL6, 0.5F, -0.3F, false, 1.0F, -0.3F, f2, 0.25F);
            this.flap(legR6, 0.5F, 0.3F, false, 1.0F, 0.3F, f2, 0.25F);
            this.flap(legL7, 0.5F, -0.3F, false, 0.0F, -0.3F, f2, 0.25F);
            this.flap(legR7, 0.5F, 0.3F, false, 0.0F, 0.3F, f2, 0.25F);
            this.flap(legL8, 0.5F, -0.4F, false, 1.0F, -0.3F, f2, 0.2F);
            this.flap(legR8, 0.5F, 0.3F, false, 1.0F, 0.3F, f2, 0.2F);
            this.flap(legL9, 0.5F, -0.3F, false, 2.0F, -0.3F, f2, 0.2F);
            this.flap(legR9, 0.5F, 0.3F, false, 2.0F, 0.3F, f2, 0.2F);
            ...
            this.flap(legL3, 0.2F, -0.5F, false, 2.0F, -0.5F, f2, 0.25F);
            this.flap(legR3, 0.2F, 0.5F, false, 2.0F, 0.5F, f2, 0.25F);
            this.flap(legL4, 0.2F, -0.4F, false, 3.0F, -0.4F, f2, 0.25F);
            this.flap(legR4, 0.2F, 0.4F, false, 3.0F, 0.4F, f2, 0.25F);
            this.flap(legL5, 0.2F, -0.4F, false, 2.0F, -0.4F, f2, 0.25F);
            this.flap(legR5, 0.2F, 0.4F, false, 2.0F, 0.4F, f2, 0.25F);
            this.flap(legL6, 0.2F, -0.4F, false, 1.0F, -0.4F, f2, 0.25F);
            this.flap(legR6, 0.2F, 0.4F, false, 1.0F, 0.4F, f2, 0.25F);
            this.flap(legL7, 0.2F, -0.4F, false, 0.0F, -0.4F, f2, 0.25F);
            this.flap(legR7, 0.2F, 0.4F, false, 0.0F, 0.4F, f2, 0.25F);
            this.flap(legL8, 0.2F, -0.4F, false, 1.0F, -0.4F, f2, 0.2F);
            this.flap(legR8, 0.2F, 0.4F, false, 1.0F, 0.4F, f2, 0.2F);
            this.flap(legL9, 0.2F, -0.3F, false, 2.0F, -0.3F, f2, 0.2F);
            this.flap(legR9, 0.2F, 0.3F, false, 2.0F, 0.3F, f2, 0.2F);
