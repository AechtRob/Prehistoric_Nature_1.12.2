...
public class ModelRhizodus extends AdvancedModelBase {
    ...
    public ModelRhizodus() {
        ...
        this.body.cubeList.add(new ModelBox(body, 0, 0, -5.5F, -9.5F, 8.5F, 11, 11, 40, 0.0F, false));
        ...
        this.pectoralfinL2.setRotationPoint(5.0F, 0.0F, 0.0F);
        this.pectoralfinL.addChild(pectoralfinL2);
        this.pectoralfinL2.cubeList.add(new ModelBox(pectoralfinL2, 82, 78, -1.0F, -2.25F, 0.0F, 10, 5, 0, 0.0F, false));
        this.pectoralfinL2.cubeList.add(new ModelBox(pectoralfinL2, 84, 56, -1.0F, -1.5F, -0.5F, 8, 4, 1, 0.0F, false));
        ...
        this.pectoralfinR2.setRotationPoint(-5.0F, 0.0F, 0.0F);
        this.pectoralfinR.addChild(pectoralfinR2);
        this.pectoralfinR2.cubeList.add(new ModelBox(pectoralfinR2, 62, 35, -9.0F, -2.25F, 0.0F, 10, 5, 0, 0.0F, false));
        this.pectoralfinR2.cubeList.add(new ModelBox(pectoralfinR2, 84, 51, -7.0F, -1.5F, -0.5F, 8, 4, 1, 0.0F, false));

        this.pelvicfinL = new AdvancedModelRenderer(this);
        this.pelvicfinL.setRotationPoint(3.0F, -1.0F, 46.0F);
        ...
        this.pelvicfinR.setRotationPoint(-3.0F, -1.0F, 46.0F);
        ...
        this.body2.setRotationPoint(0.0F, -5.0F, 48.0F);
        ...
        this.finbase2_r1.cubeList.add(new ModelBox(finbase2_r1, 88, 28, -1.49F, -12.0F, 59.75F, 3, 6, 6, 0.0F, false));
