...
import net.lepidodendron.block.BlockEggsEoraptor;
...
public class RenderEggEoraptor extends TileEntitySpecialRenderer<BlockEggsEoraptor.TileEntityEggEoraptor> {
    ...
    public RenderEggEoraptor() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockEggsEoraptor.TileEntityEggEoraptor entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
