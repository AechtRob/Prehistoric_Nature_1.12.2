...
public class RenderNestTapinocephalus extends TileEntitySpecialRenderer<BlockNestTapinocephalus.TileEntityCustom> {
    ...
    public RenderNestTapinocephalus() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestTapinocephalus.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_tapinocephalus")) {
