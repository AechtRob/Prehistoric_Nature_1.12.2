...
import net.lepidodendron.block.BlockNestCoelophysis;
...
public class RenderNestCoelophysis extends TileEntitySpecialRenderer<BlockNestCoelophysis.TileEntityCustom> {
    ...
    public RenderNestCoelophysis() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestCoelophysis.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_coelophysis")) {
