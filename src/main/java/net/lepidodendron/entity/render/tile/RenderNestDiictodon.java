...
import net.lepidodendron.block.BlockNestDiictodon;
...
public class RenderNestDiictodon extends TileEntitySpecialRenderer<BlockNestDiictodon.TileEntityCustom> {
    ...
    public RenderNestDiictodon() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestDiictodon.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_diictodon")) {
