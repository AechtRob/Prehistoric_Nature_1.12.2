...
import net.lepidodendron.block.BlockNestProsictodon;
...
public class RenderNestProsictodon extends TileEntitySpecialRenderer<BlockNestProsictodon.TileEntityCustom> {
    ...
    public RenderNestProsictodon() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestProsictodon.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_prosictodon")) {
