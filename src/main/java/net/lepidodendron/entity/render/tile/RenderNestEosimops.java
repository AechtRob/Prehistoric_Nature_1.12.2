...
public class RenderNestEosimops extends TileEntitySpecialRenderer<BlockNestEosimops.TileEntityCustom> {
    ...
    public RenderNestEosimops() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestEosimops.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_eosimops")) {
