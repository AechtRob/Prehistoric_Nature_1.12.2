...
import net.lepidodendron.block.BlockEggsInostrancevia;
...
public class RenderEggInostrancevia extends TileEntitySpecialRenderer<BlockEggsInostrancevia.TileEntityEggInostrancevia> {
    ...
    public RenderEggInostrancevia() {
        this.medium_egg = new ModelMediumEgg();
    }

    @Override
    public void render(BlockEggsInostrancevia.TileEntityEggInostrancevia entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        //EnumFacing facing = EnumFacing.NORTH;
        if (entity != null && entity.hasWorld()) {
            GlStateManager.pushMatrix();
            GlStateManager.translate(x + 0.5F, y + 2.150F, z + 0.5F);
