...
import net.lepidodendron.block.BlockNestVivaxosaurus;
...
public class RenderNestVivaxosaurus extends TileEntitySpecialRenderer<BlockNestVivaxosaurus.TileEntityCustom> {
    ...
    public RenderNestVivaxosaurus() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestVivaxosaurus.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_vivaxosaurus")) {
