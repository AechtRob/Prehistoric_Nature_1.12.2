...
import net.lepidodendron.block.BlockNestEstemmenosuchus;
...
public class RenderNestEstemmenosuchus extends TileEntitySpecialRenderer<BlockNestEstemmenosuchus.TileEntityCustom> {
    ...
    public RenderNestEstemmenosuchus() {
        this.medium_egg = new ModelMediumEgg();
    }

    @Override
    public void render(BlockNestEstemmenosuchus.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_estemmenosuchus")) {
