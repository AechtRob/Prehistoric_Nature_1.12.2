...
import net.lepidodendron.block.BlockNestScutosaurus;
...
public class RenderNestScutosaurus extends TileEntitySpecialRenderer<BlockNestScutosaurus.TileEntityCustom> {
    ...
    public RenderNestScutosaurus() {
        this.small_egg = new ModelSmallEgg();
    }

    @Override
    public void render(BlockNestScutosaurus.TileEntityCustom entity, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (eggRenderType.equals(LepidodendronMod.MODID + ":eggs_scutosaurus")) {
