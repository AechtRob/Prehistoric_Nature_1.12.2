...
public class EntityPrehistoricFloraCameroceras extends EntityPrehistoricFloraNautiloidBase {
	...
	protected void initEntityAI() {
		tasks.addTask(0, new NautiloidWanderBottomFeed(this, ANIMATION_NAUTILOID_WANDER));
	}
	...
	protected void applyEntityAttributes() {
		...
		this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(38.00);
