...
public class EntityPrehistoricFloraTitanicthys extends EntityPrehistoricFloraAgeableFishBase {
	...
	public EntityPrehistoricFloraTitanicthys(World world) {
		super(world);
		setSize(1.5F, 2.0F);
		experienceValue = 0;
	...
	protected void initEntityAI() {
		tasks.addTask(0, new AgeableFishWander(this, ANIMATION_FISH_WANDER));
	}
