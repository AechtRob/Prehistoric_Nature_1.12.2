...
public class PathNavigateGroundNoWaterClimbWood extends PathNavigate
{
    private boolean shouldAvoidSun;

    public PathNavigateGroundNoWaterClimbWood(EntityLiving entity, World worldIn)
    {
    ...
    {
        this.nodeProcessor = new WalkNodeProcessorNoWaterClimbWood();
