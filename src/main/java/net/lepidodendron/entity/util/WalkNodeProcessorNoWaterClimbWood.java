...
public class WalkNodeProcessorNoWaterClimbWood extends NodeProcessor
{
    ...
    protected PathNodeType getPathNodeTypeRaw(IBlockAccess p_189553_1_, int p_189553_2_, int p_189553_3_, int p_189553_4_)
    {
        ...
        else if (block != Blocks.TRAPDOOR && block != Blocks.IRON_TRAPDOOR && block != Blocks.WATERLILY)
        {
            ...
            else if (iblockstate.getMaterial() == Material.WOOD && block.isFullCube(iblockstate))
            {
                return PathNodeType.WALKABLE;
            }
            else if (iblockstate.getMaterial() == Material.LEAVES && block.isFullCube(iblockstate))
            {
                return PathNodeType.WALKABLE;
            }
