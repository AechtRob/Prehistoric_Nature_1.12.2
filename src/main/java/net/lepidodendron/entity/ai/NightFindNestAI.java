...
public class NightFindNestAI extends AnimationAINoAnimation<EntityPrehistoricFloraLandBase> {
    ...
    public NightFindNestAI(EntityPrehistoricFloraLandBase PrehistoricFloraLandBase, Block nestblock)
    {
    ...
    public boolean shouldExecute() {
        ...
        if (this.PrehistoricFloraLandBase.world.isDaytime()) {
            return false;
        }
