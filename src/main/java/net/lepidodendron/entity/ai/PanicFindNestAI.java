...
public class PanicFindNestAI extends EntityAIBase
{
    ...
    public PanicFindNestAI(EntityPrehistoricFloraLandBase creature, double speedIn, Block nestblock)
    {
    ...
    protected boolean findRandomPosition()
    {
        ...
        if (this.creature.getNavigator().getPath() != null
            ...
            if (creature.world.getBlockState(pathPos).getBlock() == nestblock) {
