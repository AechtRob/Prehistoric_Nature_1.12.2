...
public class HuntSmallerThanMeAIInsect<T extends EntityLivingBase> extends EntityAINearestAttackableTarget {
    private final EntityPrehistoricInsectFlyingBase entity;

    public HuntSmallerThanMeAIInsect(EntityPrehistoricInsectFlyingBase entity, Class<T> classTarget, boolean checkSight, Predicate<? super T> targetSelector) {
