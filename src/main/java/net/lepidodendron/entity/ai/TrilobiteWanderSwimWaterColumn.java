...
public class TrilobiteWanderSwimWaterColumn extends AnimationAI<EntityPrehistoricFloraTrilobiteSwimBase> {
    ...
    public boolean shouldExecute() {
        ...
        if (this.PrehistoricFloraTrilobiteSwimBase.getRNG().nextFloat() < 0.5F) {
            ...
            if (!this.PrehistoricFloraTrilobiteSwimBase.getNavigator().noPath() && !isDirectPathBetweenPoints(this.PrehistoricFloraTrilobiteSwimBase, this.PrehistoricFloraTrilobiteSwimBase.getPositionVector(), new Vec3d(path.getFinalPathPoint().x, path.getFinalPathPoint().y, path.getFinalPathPoint().z))) {
