...
public class NautiloidWanderBottomDweller extends AnimationAINoAnimation<EntityPrehistoricFloraNautiloidBase> {
    ...
    public boolean shouldExecute() {
        ...
        if (this.PrehistoricFloraNautiloidBase.getRNG().nextFloat() < 0.5F) {
            ...
            if (!this.PrehistoricFloraNautiloidBase.getNavigator().noPath() && !isDirectPathBetweenPoints(this.PrehistoricFloraNautiloidBase, this.PrehistoricFloraNautiloidBase.getPositionVector(), new Vec3d(path.getFinalPathPoint().x, path.getFinalPathPoint().y, path.getFinalPathPoint().z))) {
