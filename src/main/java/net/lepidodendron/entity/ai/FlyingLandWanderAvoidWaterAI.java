...
{
    protected final EntityPrehistoricInsectFlyingWalkingBase entity;
    protected double x;
    protected double y;
    protected double z;
    ...
    public FlyingLandWanderAvoidWaterAI(EntityPrehistoricInsectFlyingWalkingBase creatureIn, double speedIn)
    {
        this(creatureIn, speedIn, 120, 1);
    }

    public FlyingLandWanderAvoidWaterAI(EntityPrehistoricInsectFlyingWalkingBase creatureIn, double speedIn, int chanceStill)
    {
        this(creatureIn, speedIn, chanceStill, 1);
    }

    public FlyingLandWanderAvoidWaterAI(EntityPrehistoricInsectFlyingWalkingBase creatureIn, double speedIn, int chanceStill, int chanceStillInWater)
    {
