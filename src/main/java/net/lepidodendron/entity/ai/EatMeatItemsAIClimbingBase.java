...
public class EatMeatItemsAIClimbingBase extends EntityAIBase {
    private final EntityPrehistoricFloraInsectClimbingBase entity;
    private final ItemsSorter targetSorter;
    private EntityItem targetItem;

    public EatMeatItemsAIClimbingBase(EntityPrehistoricFloraInsectClimbingBase entity) {
        super();
        this.entity = entity;
