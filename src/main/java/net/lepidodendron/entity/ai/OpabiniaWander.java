...
public class OpabiniaWander extends AnimationAINoAnimation<EntityPrehistoricFloraOpabinia> {
    ...
    public boolean shouldExecute() {
        ...
        if (this.PrehistoricFloraOpabinia.getRNG().nextFloat() < 0.5F) {
            ...
            if (!this.PrehistoricFloraOpabinia.getNavigator().noPath() && !isDirectPathBetweenPoints(this.PrehistoricFloraOpabinia, this.PrehistoricFloraOpabinia.getPositionVector(), new Vec3d(path.getFinalPathPoint().x, path.getFinalPathPoint().y, path.getFinalPathPoint().z)) || path != null && path.getFinalPathPoint() != null && this.PrehistoricFloraOpabinia.getDistanceSq(path.getFinalPathPoint().x, path.getFinalPathPoint().y + 0.5, path.getFinalPathPoint().z + 0.5) < 3) {
