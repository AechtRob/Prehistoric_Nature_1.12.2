...
public class EntityPrehistoricFloraMeganeuropsis extends EntityPrehistoricInsectFlyingBase {
	...
	protected void initEntityAI() {
		this.tasks.addTask(0, new AIAttackInsect(false, this.getAttackLength()));
		...
		this.targetTasks.addTask(2, new HuntSmallerThanMeAIInsect(this, EntityPrehistoricInsectFlyingWalkingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
		this.targetTasks.addTask(3, new HuntSmallerThanMeAIInsect(this, EntityPrehistoricFloraInsectClimbingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
