...
import net.lepidodendron.entity.base.EntityPrehistoricInsectFlyingWalkingBase;
...
public class EntityPrehistoricFloraDvinia extends EntityPrehistoricFloraDiictodon {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(1, new AttackAI(this, 1.6D, false, this.getAttackLength()));
		tasks.addTask(2, new PanicFindNestAI(this, 1.6D, this.getNestBlock()));
		tasks.addTask(3, new LandWanderFindNestAI(this, this.getNestBlock()));
		tasks.addTask(4, new GrappleAI(this, 1.0D, false, this.getLookLength(), this.getGrappleAnimation(), 0.225));
		...
		this.targetTasks.addTask(1, new HuntAI(this, EntityPrehistoricInsectFlyingWalkingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
