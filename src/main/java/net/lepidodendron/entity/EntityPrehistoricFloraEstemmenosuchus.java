...
public class EntityPrehistoricFloraEstemmenosuchus extends EntityPrehistoricFloraLandBase {
	...
	public Block getNestBlock() {
		return BlockNestEstemmenosuchus.block;
	}
	...
	protected void initEntityAI() {
		...
		tasks.addTask(4, new GrappleAI(this, 1.0D, false, this.getAttackLength(), this.getGrappleAnimation(), 0.25));
		tasks.addTask(5, new LandWanderAvoidWaterAI(this, 1.0D, 100));
