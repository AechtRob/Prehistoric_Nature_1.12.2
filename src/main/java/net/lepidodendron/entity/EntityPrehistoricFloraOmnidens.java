...
public class EntityPrehistoricFloraOmnidens extends EntityPrehistoricFloraAgeableFishBase {
	...
	protected void initEntityAI() {
		tasks.addTask(0, new AttackAI(this, 1.0, false, this.getAttackLength()));
		tasks.addTask(1, new OmnidensWanderBottom(this, NO_ANIMATION));
		...
		this.targetTasks.addTask(2, new HuntAI(this, EntityPrehistoricFloraSlitheringWaterBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
