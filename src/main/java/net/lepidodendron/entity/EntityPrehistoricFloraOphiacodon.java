...
public class EntityPrehistoricFloraOphiacodon extends EntityPrehistoricFloraLandBase {
	...
	protected void initEntityAI() {
		...
		tasks.addTask(4, new LandWanderFindNestAI(this, BlockRottenLog.block));
		...
		this.targetTasks.addTask(2, new HuntAI(this, EntityPrehistoricFloraInsectClimbingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
		this.targetTasks.addTask(3, new HuntAI(this, EntityPrehistoricInsectFlyingBase.class, true, (Predicate<Entity>) entity -> entity instanceof EntityLivingBase));
	}
