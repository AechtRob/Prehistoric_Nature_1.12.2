...
public class BlockEggsHylonomus extends ElementsLepidodendronMod.ModElement {
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockEggsHylonomus.TileEntityEggsHylonomus.class, "lepidodendron:tileentityeggs_hylonomus");
	}
	...
	public static class BlockCustom extends BlockReptileEggs {
		...
		public static int getIncubation() {return 4000;}
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockEggsHylonomus.TileEntityEggsHylonomus();
		}

		public BlockEggsHylonomus.TileEntityEggsHylonomus createNewTileEntity(World worldIn, int meta) {
			return new BlockEggsHylonomus.TileEntityEggsHylonomus();
		}
		...
		public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state)
		{
			...
			if (te != null) {
				if (te instanceof TileEntityEggsHylonomus) {
					BlockEggsHylonomus.TileEntityEggsHylonomus Egg = (BlockEggsHylonomus.TileEntityEggsHylonomus) te;
					Egg.setIncubation(0);
				}
			}
		}
		...
		public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
			...
			TileEntity te = worldIn.getTileEntity(pos);
			if (te != null) {
				if (te instanceof BlockEggsHylonomus.TileEntityEggsHylonomus) {
					BlockEggsHylonomus.TileEntityEggsHylonomus Egg = (BlockEggsHylonomus.TileEntityEggsHylonomus) te;
					Egg.setIncubation(0);
				}
			}
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
		{
			...
			if (incubation >= this.getIncubation()) {
				if (!(worldIn.isRemote)) {
					EntityPrehistoricFloraAgeableBase.summon(worldIn, EntityList.getKey(EntityPrehistoricFloraHylonomus.class).toString(), "{AgeTicks:0}", (double) pos.getX() + 0.5D, (double) pos.getY() + 0.5D, (double) pos.getZ() + 0.5D);
				}
	...
	public static class TileEntityEggsHylonomus extends TileEntity implements ITickable {

		private int incubation;

		@Override
		public void update() {
			if (this.incubation <= BlockEggsHylonomus.BlockCustom.getIncubation()) {
