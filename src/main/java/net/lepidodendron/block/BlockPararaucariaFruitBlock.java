...
import net.lepidodendron.item.ItemPararaucariaNuts;
...
public class BlockPararaucariaFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:pararaucaria_fruit_block")
	public static final Block block = null;
	public BlockPararaucariaFruitBlock(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.pararaucaria_fruit_block);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("pararaucaria_fruit_block"));
	...
	public static class BlockCustom extends BlockFalling {
		public BlockCustom() {
			...
			setTranslationKey("pf_pararaucaria_fruit_block");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemPararaucariaNuts.block, (int) (3)));
