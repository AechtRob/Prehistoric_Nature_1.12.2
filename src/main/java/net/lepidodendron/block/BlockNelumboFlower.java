...
public class BlockNelumboFlower extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends BlockLilyPad implements net.minecraftforge.common.IShearable {
		public BlockCustom() {
			...
			setTranslationKey("nelumbo_flower_worldgen");
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    {
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != Item.getItemFromBlock(BlockNelumboFlowerPlaceable.block)) || !LepidodendronConfig.doFlowers)
	        {
	            return true;
	        }
	        else {
