...
public class BlockNestMoschops extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nest_moschops")
	public static final Block block = null;
	public BlockNestMoschops(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nest_moschops);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nest_moschops"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNestMoschops.TileEntityCustom.class, "lepidodendron:tileentitynest_moschops");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nest_moschops", "inventory"));
	}
	public static class BlockCustom extends Block implements IShearable {
		...
		public void SpawnEggs(World world, BlockPos pos) {
			...
			if (!eggRenderType.equals("")) {
				Block blockSpawn = BlockEggsMoschops.block;
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNestMoschops.TileEntityCustom();
		}

		public BlockNestMoschops.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNestMoschops.TileEntityCustom();
		}
