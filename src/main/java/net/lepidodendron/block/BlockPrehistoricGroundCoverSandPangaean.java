...
public class BlockPrehistoricGroundCoverSandPangaean extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:sandy_prehistoric_ground_cover_pangaean")
	public static final Block block = null;
	public BlockPrehistoricGroundCoverSandPangaean(ElementsLepidodendronMod instance) {
		super(instance, 526);
	}
		                ...
		                if (worldIn.getLightFromNeighbors(pos.up()) >= 9)
		                {
		                    for (int i = 0; i < 4; ++i)
		                    {
								...
								)
		                        {
									...
									if (waterCriteria)
		                            	worldIn.setBlockState(blockpos, BlockPrehistoricGroundCoverSandPangaean.block.getDefaultState());
		                        }
		                    }
	                    }
	                }
