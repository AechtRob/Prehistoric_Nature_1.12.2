...
import net.lepidodendron.item.ItemLithiotisItem;
...
public class BlockLithiotis extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lithiotis")
	public static final Block block = null;
	public BlockLithiotis(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.lithiotis);
	}
	...
	//			new ModelResourceLocation("lepidodendron:lithiotis", "inventory"));
	//}
	...
	public static class BlockCustom extends BlockLilyPad implements IGrowable {
		public BlockCustom() {
			...
			setTranslationKey("pf_lithiotis");
			setRegistryName("lithiotis");
		}
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemLithiotisItem.block, (int) (1));
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doSpores) {
				...
				drops.add(new ItemStack(ItemLithiotisItem.block, (int) (1)));
			}
		}
