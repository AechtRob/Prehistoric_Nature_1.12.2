...
public class BlockInsectEggsAttercopusPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_attercopus")
	public static final Block block = null;
	public BlockInsectEggsAttercopusPlaceable(ElementsLepidodendronMod instance) {
