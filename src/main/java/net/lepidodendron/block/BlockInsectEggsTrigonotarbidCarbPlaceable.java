...
public class BlockInsectEggsTrigonotarbidCarbPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_trigonotarbid_carb")
	public static final Block block = null;
	public BlockInsectEggsTrigonotarbidCarbPlaceable(ElementsLepidodendronMod instance) {
