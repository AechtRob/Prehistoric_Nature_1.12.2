...
public class BlockPrimevalGrassLand extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends BlockBush implements IGrowable, net.minecraftforge.common.IShearable {
		public BlockCustom() {
			...
			setTranslationKey("primaeval_grass_land");
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			if (LepidodendronConfig.doFlowers) {
	    ...
	    {
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(ItemPrimevalGrassItem.block, (int) (1)).getItem()) || !LepidodendronConfig.doFlowers)
	        {
	            return true;
	        }
	        else {
