...
public class BlockPrehistoricGroundCover extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:lush_prehistoric_ground_cover")
	public static final Block block = null;
	public BlockPrehistoricGroundCover(ElementsLepidodendronMod instance) {
		super(instance, 526);
	}
