...
public class BlockNestDimetrodon extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:nest_dimetrodon")
	public static final Block block = null;
	public BlockNestDimetrodon(ElementsLepidodendronMod instance) {
		super(instance, LepidodendronSorter.nest_dimetrodon);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("nest_dimetrodon"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(BlockNestDimetrodon.TileEntityCustom.class, "lepidodendron:tileentitynest_dimetrodon");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("lepidodendron:nest_dimetrodon", "inventory"));
	}
	public static class BlockCustom extends Block implements IShearable {
		...
		public void SpawnEggs(World world, BlockPos pos) {
			...
			if (!eggRenderType.equals("")) {
				Block blockSpawn = BlockEggsDimetrodon.block;
		...
		public TileEntity createTileEntity(World world, IBlockState state) {
			return new BlockNestDimetrodon.TileEntityCustom();
		}

		public BlockNestDimetrodon.TileEntityCustom createNewTileEntity(World worldIn, int meta) {
			return new BlockNestDimetrodon.TileEntityCustom();
		}
