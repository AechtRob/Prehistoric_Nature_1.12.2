...
import net.lepidodendron.item.ItemMonkeyPuzzleNuts;
...
public class BlockMonkeyPuzzleFruitBlock extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:monkeypuzzle_fruit_block")
	public static final Block block = null;
	public BlockMonkeyPuzzleFruitBlock(ElementsLepidodendronMod instance) {
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			...
			drops.add(new ItemStack(ItemMonkeyPuzzleNuts.block, (int) (3)));
