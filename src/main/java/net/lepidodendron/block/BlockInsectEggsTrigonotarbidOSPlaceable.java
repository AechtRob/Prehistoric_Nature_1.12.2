...
public class BlockInsectEggsTrigonotarbidOSPlaceable extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:insect_eggs_trigonotarbid_os")
	public static final Block block = null;
	public BlockInsectEggsTrigonotarbidOSPlaceable(ElementsLepidodendronMod instance) {
	...
	public static class BlockCustom extends BlockInsectEggs {
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
		{
			...
			if (worldIn.getBlockState(pos).getBlock() == this && !(worldIn.isRemote)) {
				...
				Entity entity1 = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getKey(EntityPrehistoricFloraTrigonotarbid_Palaeotarbus.class), (double)pos.getX() + 0.5D, (double)pos.getY() + 0.5D, (double)pos.getZ() + 0.5D);
				Entity entity2 = null;
				if (Math.random() > 0.75) {
					entity2 = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getKey(EntityPrehistoricFloraTrigonotarbid_Palaeotarbus.class), (double)pos.getX() + 0.5D, (double)pos.getY() + 0.5D, (double)pos.getZ() + 0.5D);
				}
