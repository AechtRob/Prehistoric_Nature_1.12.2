...
public class BlockCageSmall extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends Block {
		...
		protected static final AxisAlignedBB AABBN = new AxisAlignedBB(0.0D, 0.0D, 0.00D, 1.0D, 1.5D, 0.00D);
		protected static final AxisAlignedBB AABBS = new AxisAlignedBB(0.0D, 0.0D, 1.00D, 1.0D, 1.5D, 1.0D);
		protected static final AxisAlignedBB AABBE = new AxisAlignedBB(1.00D, 0.0D, 0.0D, 1.0D, 1.5D, 1.0D);
		protected static final AxisAlignedBB AABBW = new AxisAlignedBB(0.00D, 0.0D, 0.0D, 0.00D, 1.5D, 1.0D);
		protected static final AxisAlignedBB AABBU = new AxisAlignedBB(0.0D, 1.50D, 0.0D, 1.0D, 1.5D, 1.0D);
