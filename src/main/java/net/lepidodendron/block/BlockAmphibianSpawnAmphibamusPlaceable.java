...
public class BlockAmphibianSpawnAmphibamusPlaceable extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends BlockMobSpawn  {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockAmphibianSpawnAmphibamusPlaceable.block, (int) (1)));
		}
		...
		public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) 
		{
			...
			if (!(worldIn.isRemote)) {
				Entity entity = ItemMonsterPlacer.spawnCreature(worldIn, EntityList.getKey(EntityPrehistoricFloraAmphibamus.class), pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5);
				if (entity != null) {
		...
		public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
			...
			if (!itemstack.isEmpty()) {
				if (itemstack.getItem() == Items.WATER_BUCKET) {
					...
					ItemStack itemstack1 = new ItemStack(ItemBucketSpawnAmphibamus.block, (int) (1));
