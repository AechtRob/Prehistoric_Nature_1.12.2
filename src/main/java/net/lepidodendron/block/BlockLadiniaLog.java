...
public class BlockLadiniaLog extends ElementsLepidodendronMod.ModElement {
    ...
    public static final PropertyBool LEAVES = PropertyBool.create("leaves");
		...
		public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	    {
			...
			if ((block1 == BlockLadiniaShoot.block) || (block1 == BlockLadiniaShootPlaceable.block) || (block1 == BlockLadiniaShootMale.block) || (block1 == BlockLadiniaShootMalePlaceable.block)) {
				leavesattached = true;
				leavesblock1 = true;
	    	}
