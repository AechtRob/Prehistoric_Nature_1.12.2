...
public class BlockMonkeypuzzleLeaves extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:monkeypuzzle_leaves")
	public static final Block block = null;
	public BlockMonkeypuzzleLeaves(ElementsLepidodendronMod instance) {
		super(instance, 225);
	}
    ...
    public BlockRenderLayer getRenderLayer()
    {
		...
		public Item getItemDropped(IBlockState state, java.util.Random rand, int fortune) {
			if (LepidodendronConfig.doFruits) {
				...
				return Item.getItemFromBlock(BlockMonkeypuzzleSapling.block);
			}
		}
		...
		public void breakBlock(World worldIn, BlockPos pos, IBlockState state)  {
			...
			if ((Math.random() >= 0.95) && (LepidodendronConfig.doFruits)) {
				IBlockState _bs = BlockMonkeyPuzzleFruitBlock.block.getDefaultState();
