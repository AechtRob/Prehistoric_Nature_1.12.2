...
public class BlockCobbania extends ElementsLepidodendronMod.ModElement {
    ...
    public BlockRenderLayer getRenderLayer()
    {
	    ...
	    {
        if ((!player.capabilities.allowEdit) || (player.getHeldItemMainhand().getItem() != new ItemStack(ItemCobbaniaItem.block, (int) (1)).getItem()) || !LepidodendronConfig.doFlowers)
	        {
	            return true;
	        }
	        else {
