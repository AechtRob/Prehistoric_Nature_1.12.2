...
import net.lepidodendron.item.ItemPhialEggsJaekelopterus;
...
public class BlockEurypteridEggsJaekelopterus extends ElementsLepidodendronMod.ModElement {
	...
	public static class BlockCustom extends BlockMobSpawn {
		...
		public NonNullList<ItemStack> onSheared(ItemStack item, net.minecraft.world.IBlockAccess world, BlockPos pos, int fortune) {
			return NonNullList.withSize(1, new ItemStack(BlockEurypteridEggsJaekelopterusPlaceable.block, (int) (1)));
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
		{
			if (!player.capabilities.allowEdit)
			{
				...
				if (player.getHeldItemMainhand().getItem() == new ItemStack(ItemPhial.block, (int) (1)).getItem()) {
					...
					ItemStack _setstack = new ItemStack(ItemPhialEggsJaekelopterus.block, (int) (1));
