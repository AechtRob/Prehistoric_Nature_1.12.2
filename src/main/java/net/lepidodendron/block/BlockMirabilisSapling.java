...
public class BlockMirabilisSapling extends ElementsLepidodendronMod.ModElement {
	@GameRegistry.ObjectHolder("lepidodendron:mirabilis_sapling")
	public static final Block block = null;
	public BlockMirabilisSapling(ElementsLepidodendronMod instance) {
		super(instance, 286);
	}
	...
	public static class BlockCustom extends BlockBush implements IGrowable {
		public BlockCustom() {
			...
			setHardness(0.2F);
        	setResistance(1F);
			setTranslationKey("mirabilis_sapling");
