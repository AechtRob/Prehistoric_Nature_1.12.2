...
public class GuiResinExtraction extends ElementsLepidodendronMod.ModElement {
	...
	public GuiResinExtraction(ElementsLepidodendronMod instance) {
		super(instance, 1176);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 43, 13) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(Items.GLASS_BOTTLE, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 115, 13) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			...
			for (si = 0; si < 3; ++si)
				for (sj = 0; sj < 9; ++sj)
					this.addSlotToContainer(new Slot(player.inventory, sj + (si + 1) * 9, 0 + 8 + sj * 18, -42 + 84 + si * 18));
			for (si = 0; si < 9; ++si)
				this.addSlotToContainer(new Slot(player.inventory, si, 0 + 8 + si * 18, -42 + 142));
		}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("lepidodendron:textures/resin_extraction.png");
		@Override
