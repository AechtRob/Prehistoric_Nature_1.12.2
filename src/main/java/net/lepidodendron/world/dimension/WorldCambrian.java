...
public class WorldCambrian extends ElementsLepidodendronMod.ModElement {
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11+1, k12),
								flag1 ? Blocks.SPONGE.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
					...
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							this.world.setBlockState(new BlockPos(i2, j2, k2),
									flag
											? Blocks.SPONGE.getDefaultState().getBlock().getDefaultState()
											: Blocks.AIR.getDefaultState());
						}
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				return block == Blocks.SPONGE.getDefaultState().getBlock() ? i : 0;
			}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE2 = Blocks.GRAVEL.getStateFromMeta(0);
