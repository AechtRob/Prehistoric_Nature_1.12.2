...
public class WorldPrecambrian extends ElementsLepidodendronMod.ModElement {
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockLavaRock.block.getDefaultState();
		private static final IBlockState STONE2 = BlockBacterialLayer.block.getDefaultState();
