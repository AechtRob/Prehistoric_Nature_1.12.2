    ...
    public void populate(int x, int z) {
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, this.world, this.random, x, z, false,
            ...
            if (biome == BiomeDevonianFloodplain.biome || biome == BiomeDevonianSprings.biome || biome == BiomeDevonianHills.biome) {
                String[] MobString = LepidodendronConfig.dimDevonianMobsForestBespoke;
                        ...
                        if (j1 >= i - 1) {
                            ...
                            if ((j1 < i - 10 && Math.random() > 0.5)) {
                                ...
                                if (Math.random() > 0.85) {
                                    ...
                                    if (Math.random() > 0.5) {
                                        if (j1 < i - 3) {
                                            if (biome != BiomeDevonianOcean.biome && biome != BiomeDevonianOceanDeep.biome && biome != BiomeDevonianSandyBeach.biome && biome != BiomeDevonianForest.biome) {
                                                if (Math.random() > 0.66) {
