        ...
        for (int i1 = 0; i1 < p_151626_4_; ++i1)
        {
            for (int j1 = 0; j1 < p_151626_3_; ++j1)
            {
                ...
                if (k1 == CARBONIFEROUS_OCEAN_ID)
                {
                    ...
                    boolean flag = (
                        (l1 == CARBONIFEROUS_SWAMP_ID || l1 == CARBONIFEROUS_SWAMP_HILLS_ID || l1 == CARBONIFEROUS_BEACH_ID)
                        || (i2 == CARBONIFEROUS_SWAMP_ID || i2 == CARBONIFEROUS_SWAMP_HILLS_ID || i2 == CARBONIFEROUS_BEACH_ID)
                        || (j2 == CARBONIFEROUS_SWAMP_ID || j2 == CARBONIFEROUS_SWAMP_HILLS_ID || j2 == CARBONIFEROUS_BEACH_ID)
                        || (k2 == CARBONIFEROUS_SWAMP_ID || k2 == CARBONIFEROUS_SWAMP_HILLS_ID || k2 == CARBONIFEROUS_BEACH_ID)
                    );
                    if (flag)
                    {
