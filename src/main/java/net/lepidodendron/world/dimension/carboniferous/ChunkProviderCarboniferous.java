...
public class ChunkProviderCarboniferous implements IChunkGenerator {
    ...
    public void populate(int x, int z) {
        ...
        if (this.random.nextInt(4) == 0 && biome != BiomeCarboniferousIce.biome && biome != BiomeCarboniferousIceSpikes.biome && biome != BiomeCarboniferousIceEdge.biome && biome != BiomeCarboniferousBeach.biome && biome != BiomeCarboniferousOceanShore.biome)
