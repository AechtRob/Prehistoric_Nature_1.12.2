...
public class GenLayerIcebergsOrdovician extends GenLayer {
    ...
    public  Biome OS_SEA_ICE = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:ordovician_silurian_sea_ice"));
    public  int OS_SEA_ICE_ID =  Biome.getIdForBiome(OS_SEA_ICE);
    public  Biome OS_ICEBERGS = Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:ordovician_silurian_sea_icebergs"));
