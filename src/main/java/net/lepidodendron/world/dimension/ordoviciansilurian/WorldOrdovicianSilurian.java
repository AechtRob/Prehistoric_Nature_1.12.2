...
public class WorldOrdovicianSilurian extends ElementsLepidodendronMod.ModElement {
	public static int DIMID = LepidodendronConfig.dimOrdovicianSilurian;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("lepidodendron:ordovician_silurian_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldOrdovicianSilurian(ElementsLepidodendronMod instance) {
		super(instance, 1590);
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		@Override
		public void init() {
			this.biomeProvider = new BiomeProviderOrdovicianSilurian(this.world.getSeed(), this.world.getWorldInfo());
		...
		public IChunkGenerator createChunkGenerator() {
			return new ChunkProviderOrdovicianSilurian(this.world, this.world.getSeed() - DIMID);
		}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setTranslationKey("pf_ordovician_silurian_portal");
			setRegistryName("ordovician_silurian_portal");
			setLightLevel(0F);
		}
			...
			if (!worldIn.isRemote && !entityIn.isRiding() && !entityIn.isBeingRidden() && entityIn instanceof EntityPlayerMP) {
				...
				if (thePlayer.timeUntilPortal > 0) {
					...
					if (thePlayer.dimension == DIMID) {
						...
						ModTriggers.ENTER_ORDOVICIAN_SILURIAN.trigger((EntityPlayerMP)thePlayer);
					}
				} else {
					thePlayer.timeUntilPortal = 10;
					ReflectionHelper.setPrivateValue(EntityPlayerMP.class, thePlayer, true, "invulnerableDimensionChange", "field_184851_cj");
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:ordovician_silurian_land")),
				Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:ordovician_silurian_biome")),
