...
public class WorldPermianGlossopteris extends ElementsLepidodendronMod.ModElement {
	//public static int DIMID = LepidodendronConfig.dimPermianGlossopteris;
	public static int DIMID = -83;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("lepidodendron:permian_glossopteris_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldPermianGlossopteris(ElementsLepidodendronMod instance) {
		super(instance, 1590);
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Prehistoric Nature loading error! Dimension ID for the Permian Glossopteris dimension is already registered by another mod: " + DIMID);
			return;
		}
		dtype = DimensionType.register("permian_glossopteris", "_permian_glossopteris", DIMID, WorldProviderMod.class, false);
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setTranslationKey("pf_permian_glossopteris_portal");
			setRegistryName("permian_glossopteris_portal");
			setLightLevel(0F);
		}
