...
public class BiomeCambrianSea extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new BiomeProperties("The Cambrian").setRainfall(0.9F).setBaseHeight(-1.5F).setHeightVariation(0.02F).setTemperature(0.9F));
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			{
				String[] var2 = LepidodendronConfig.dimCambrianMobs;
