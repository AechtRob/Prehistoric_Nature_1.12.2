...
public class BiomePrecambrianSea extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new BiomeProperties("The Precambrian Sea").setRainfall(0.95F).setBaseHeight(-1.5F).setHeightVariation(0.07F).setTemperature(0.1F).setWaterColor(11556675));
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			{
				String[] MobString = LepidodendronConfig.dimPrecambrianMobsBespoke;
