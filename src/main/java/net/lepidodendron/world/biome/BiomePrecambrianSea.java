...
public class BiomePrecambrianSea extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new BiomeProperties("The Precambrian Sea").setRainfall(0.95F).setBaseHeight(-1.5F).setHeightVariation(0.07F).setTemperature(0.1F));
	    ...
	    public void decorate(World worldIn, Random rand, BlockPos pos)
	    {
			...
			{
				ChunkGenSpawner.executeProcedure(true, LepidodendronConfig.dimPrecambrianMobs, worldIn, topBlock, pos, rand);
			}
