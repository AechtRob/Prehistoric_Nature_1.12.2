...
public class BiomeCarboniferousIceEdge extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			super(new BiomeProperties("Carboniferous Polar Desert Edge").setRainfall(0.1F).setBaseHeight(0.06F).setHeightVariation(0.08F).setTemperature(-1.5F).setSnowEnabled());
