...
public class BiomeCarboniferousSwampHills extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeCarboniferous {
		public BiomeGenCustom() {
			...
			super(new Biome.BiomeProperties("Carboniferous Swamp Hills").setRainfall(0.5F).setBaseBiome("lepidodendron:carboniferous_swamp").setBaseHeight(-0.06F).setHeightVariation(0.36F).setTemperature(0.8F).setRainfall(0.9F).setWaterColor(3906905));
