...
public class BiomeJurassicSandbanksRaised extends ElementsLepidodendronMod.ModElement {
	...
	static class BiomeGenCustom extends BiomeJurassic {
		public BiomeGenCustom() {
			//was height 0.001
			super(new BiomeProperties("Jurassic Skerries").setBaseHeight(0.05F).setHeightVariation(0F).setTemperature(1.9F).setRainDisabled());
		...
		protected static final WorldGenLithiotis LITHIOTIS_GENERATOR = new WorldGenLithiotis();
		...
		public void decorate(World worldIn, Random rand, BlockPos pos)
		{
			...
			if(net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, new net.minecraft.util.math.ChunkPos(pos), net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.GRASS))
				for (int i = 0; i < 32; ++i)
				{
					...
					int k = rand.nextInt(16) + 8;
					int l = rand.nextInt(worldIn.getHeight(pos.add(j, 0, k)).getY() + 32);
					//LITHIOTIS_GENERATOR.generate(worldIn, rand, pos.add(j, l, k));
				}
