...
public class WorldCarboniferous extends ElementsLepidodendronMod.ModElement {
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Prehistoric Flora loading error! Dimension ID for dimension Carboniferous is already registered by another mod: " + DIMID);
			return;
		}
		dtype = DimensionType.register("carboniferous", "_carboniferous", DIMID, WorldProviderMod.class, true);
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setTranslationKey("carboniferous_portal");
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:carboniferous_swamp")),
