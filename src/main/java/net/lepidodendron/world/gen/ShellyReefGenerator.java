				...
				if (this.reef.canPlaceBlockAt(worldIn, new BlockPos(j, k, l))
					...
					if (worldIn.getBlockState(new BlockPos(j, k - 1, l - 1)).getMaterial() == Material.WATER
						...
						if (((worldIn.getBlockState(pos).getMaterial() == Material.SAND)
							...
							worldIn.setBlockState(new BlockPos(j, k - 1, l - 1), this.state, 2);
							worldIn.setBlockState(new BlockPos(j, k - 1, l + 1), this.state, 2);
							if (rand.nextInt(10) ==0) {
								worldIn.setBlockState(new BlockPos(j, k + 1, l), this.state, 2);
								worldIn.setBlockState(new BlockPos(j, k - 1, l - 2), this.state, 2);
								worldIn.setBlockState(new BlockPos(j, k - 1, l + 2), this.state, 2);
								worldIn.setBlockState(new BlockPos(j, k, l - 1), this.state, 2);
								worldIn.setBlockState(new BlockPos(j, k, l + 1), this.state, 2);
							}
						}
					}
					...
					if (worldIn.getBlockState(new BlockPos(j + 1, k - 1, l)).getMaterial() == Material.WATER
						...
						if (((worldIn.getBlockState(pos).getMaterial() == Material.SAND)
							...
							worldIn.setBlockState(new BlockPos(j, k, l), this.state, 2);
							worldIn.setBlockState(new BlockPos(j - 1, k - 1, l), this.state, 2);
							worldIn.setBlockState(new BlockPos(j + 1, k - 1, l), this.state, 2);
							if (rand.nextInt(10) ==0) {
								worldIn.setBlockState(new BlockPos(j, k + 1, l), this.state, 2);
								worldIn.setBlockState(new BlockPos(j - 2, k - 1, l), this.state, 2);
								worldIn.setBlockState(new BlockPos(j + 2, k - 1, l), this.state, 2);
								worldIn.setBlockState(new BlockPos(j - 1, k, l), this.state, 2);
								worldIn.setBlockState(new BlockPos(j + 1, k, l), this.state, 2);
							}
						}
					}
