...
public class WorldOrdovicianSilurian extends ElementsLepidodendronMod.ModElement {
	...
	public void initElements() {
		...
		//elements.items.add(() -> new ItemDevonian().setTranslationKey("devonian").setRegistryName("devonian"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		dtype = DimensionType.register("ordovician_silurian", "_ordovician_silurian", DIMID, WorldProviderMod.class, true);
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setTranslationKey("ordovician_silurian_portal");
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("lepidodendron:ordovician_silurian_biome")),
