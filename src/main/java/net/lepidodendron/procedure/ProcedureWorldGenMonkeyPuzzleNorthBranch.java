...
public class ProcedureWorldGenMonkeyPuzzleNorthBranch extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenMonkeyPuzzleNorthBranch(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenMonkeyPuzzleNorthBranch!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenMonkeyPuzzleNorthBranch!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenMonkeyPuzzleNorthBranch!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenMonkeyPuzzleNorthBranch!");
			return;
		}
		if (dependencies.get("TrunkHeight") == null) {
			System.err.println("Failed to load dependency TrunkHeight for procedure WorldGenMonkeyPuzzleNorthBranch!");
			return;
		}
		if (dependencies.get("smalltree") == null) {
			System.err.println("Failed to load dependency smalltree for procedure WorldGenMonkeyPuzzleNorthBranch!");
			return;
		}
		...
		if (Math.random() > 0.5) {
			ProcedureTreeLog.executeProcedure(xx - 3, yy, zz, world, BlockMonkeypuzzleLog.block, EnumFacing.UP);
			ProcedureLeavesAroundLog.executeProcedure(xx - 3, yy, zz, world, BlockMonkeypuzzleLeaves.block, 1, 0.45 * densifier);
			ProcedureTreeLog.executeProcedure(xx - 3, yy, zz - 1, world, BlockMonkeypuzzleLog.block, EnumFacing.WEST);
			ProcedureLeavesAroundLog.executeProcedure(xx - 3, yy, zz - 1, world, BlockMonkeypuzzleLeaves.block, 2, 0.2 * densifier);
		}
		else {
