...
public class ProcedureWorldGenMonkeyPuzzleEastBranch extends ElementsLepidodendronMod.ModElement {
	public ProcedureWorldGenMonkeyPuzzleEastBranch(ElementsLepidodendronMod instance) {
		super(instance, 42);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure WorldGenMonkeyPuzzleEastBranch!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure WorldGenMonkeyPuzzleEastBranch!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure WorldGenMonkeyPuzzleEastBranch!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure WorldGenMonkeyPuzzleEastBranch!");
			return;
		}
		if (dependencies.get("TrunkHeight") == null) {
			System.err.println("Failed to load dependency TrunkHeight for procedure WorldGenMonkeyPuzzleEastBranch!");
			return;
		}
		if (dependencies.get("smalltree") == null) {
			System.err.println("Failed to load dependency smalltree for procedure WorldGenMonkeyPuzzleEastBranch!");
			return;
		}
